...
# Configuration
# ---------------------------------------------------------------------------
BASE_DIR = os.path.dirname(os.path.abspath(__file__)) # .../integration/admin
INTEGRATION_DIR = os.path.dirname(BASE_DIR)            # .../integration
...
def run_test_file(filename):
    ...
    print(f"\n>>> Running Integration Test: {filename} <<<")
    cmd = [sys.executable, filename]
    env = os.environ.copy()
    # Add paths to PYTHONPATH so tests can find helpers.py
...
def main():
    print("="*80)
    print("  NextGen Smart Store — Admin INTEGRATION Tests")
    print("  Testing End-to-End System Workflows")
    print("="*80)
