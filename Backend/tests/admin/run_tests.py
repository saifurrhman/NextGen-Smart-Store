...
# Exclude auth if we want to run it first? Actually they are independent.
TEST_FILES.sort()
...
def main():
    print("="*70)
    print("  NextGen Smart Store — Admin Modular Unit Tests (Multi-Process)")
    print("="*70)
    ...
    for test_file in TEST_FILES:
        ...
        # Print abbreviated output if success, full if fail
        if success:
