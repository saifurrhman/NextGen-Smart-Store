...
import { RefreshCcw, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your refunds & returns</p>
                </div>
                {!false && (
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="bg-gray-50/50 text-gray-500 font-medium border-b border-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-3">RMA ID</th>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">RMA-992</td>
                                <td className="px-6 py-4 text-gray-600">
                                    #ORD-0091
                                </td>
                                <td className="px-6 py-4 text-gray-600">Sara Khan</td>
                                <td className="px-6 py-4 text-gray-600">PKR 12,000</td>
                                <td className="px-6 py-4 text-gray-600">Damaged Item</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">RMA-991</td>
                                <td className="px-6 py-4 text-gray-600">
                                    #ORD-0050
                                </td>
                                <td className="px-6 py-4 text-gray-600">Waqas Ali</td>
                                <td className="px-6 py-4 text-gray-600">PKR 500</td>
                                <td className="px-6 py-4 text-gray-600">Wrong Size</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
