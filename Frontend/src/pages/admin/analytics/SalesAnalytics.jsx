        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your sales analytics</p>
                </div>
                {!false && (
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5 border-b border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50/30">
                    <div className="relative flex-1 w-full max-w-md">
                        ...
                        <input 
                            type="text" 
                            placeholder="Search in Sales Analytics..." 
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-gray-600">PKR 2.1M</td>
                                <td className="px-6 py-4 text-gray-600">+14.2%</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-gray-600">PKR 1,180</td>
                                <td className="px-6 py-4 text-gray-600">+5.9%</td>
                                <td className="px-6 py-4 text-gray-600">Up</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-gray-600">2.8%</td>
                                <td className="px-6 py-4 text-gray-600">+14.2%</td>
                                <td className="px-6 py-4 text-gray-600">Up</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Cart Abandonment</td>
                                <td className="px-6 py-4 text-gray-600">
                                    65%
                                </td>
                                <td className="px-6 py-4 text-gray-600">68%</td>
