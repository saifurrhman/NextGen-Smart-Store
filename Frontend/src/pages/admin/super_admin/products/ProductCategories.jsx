        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your product categories</p>
                </div>
                {!false && (
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Electronics</td>
                                <td className="px-6 py-4 text-gray-600">
                                    electronics
                                </td>
                                <td className="px-6 py-4 text-gray-600">1,240</td>
                                <td className="px-6 py-4 text-gray-600">PKR 12.5M</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Beauty & Health</td>
                                <td className="px-6 py-4 text-gray-600">
                                    beauty-health
                                </td>
                                <td className="px-6 py-4 text-gray-600">840</td>
                                <td className="px-6 py-4 text-gray-600">PKR 8.2M</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    Manage
                                </td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Home & Kitchen</td>
                                <td className="px-6 py-4 text-gray-600">
                                    home-kitchen
                                </td>
                                <td className="px-6 py-4 text-gray-600">2,100</td>
                                <td className="px-6 py-4 text-gray-600">PKR 5.1M</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    Manage
                                </td>
