...
import { MessageSquare, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">CHAT-1029</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Guest_8492
                                </td>
                                <td className="px-6 py-4 text-gray-600">Product Inquiry</td>
                                <td className="px-6 py-4 text-gray-600">Agent Sana</td>
                                <td className="px-6 py-4 text-gray-600">4m 12s</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">CHAT-1028</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Ali Raja
                                </td>
                                <td className="px-6 py-4 text-gray-600">Order Delay</td>
                                <td className="px-6 py-4 text-gray-600">Agent Bilal</td>
                                <td className="px-6 py-4 text-gray-600">12m 45s</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-green-50 text-green-700"><span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>Active</span>
                                </td>
                                <td className="px-6 py-4 text-right">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">CHAT-1027</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Guest_1120
                                </td>
                                <td className="px-6 py-4 text-gray-600">General Question</td>
                                <td className="px-6 py-4 text-gray-600">Unassigned</td>
                                <td className="px-6 py-4 text-gray-600">1m 20s</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700"><span className="w-1.5 h-1.5 rounded-full bg-amber-500"></span>Waiting</span>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
