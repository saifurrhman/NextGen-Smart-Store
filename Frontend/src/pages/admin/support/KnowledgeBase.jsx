...
import { BookOpen, Search, Filter, Plus, Edit2, Trash2, ChevronLeft, ChevronRight, FileText } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage help articles and documentation for users</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="overflow-x-auto min-h-[400px]">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-[#f0f9ff] text-blue-800 font-bold tracking-wider">
                            <tr>
                            ...
                            {loading ? (
                                ...
                                articles.map((article) => (
                                    <tr key={article.id} className="hover:bg-gray-50/50 transition-colors group">
                                        <td className="px-6 py-4 font-mono font-bold text-gray-400">#KB-{article.id}</td>
                                ...
                                <tr>
                                    <td colSpan="5" className="py-20 text-center text-gray-400 font-bold uppercase tracking-widest bg-gray-50/50">
                                        No articles found.
                                    </td>
                                </tr>
                            )}
                ...
                {pagination.count > 20 && (
                    <div className="p-4 border-t border-gray-100 text-sm text-gray-500 flex items-center justify-between">
                        <span>Showing {articles.length} entries of {pagination.count}</span>
                        <div className="flex gap-1">
                            {/* Pagination buttons - similar to Tickets */}
                        </div>
                    </div>
                )}
            </div>
