...
import { Users, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your all users</p>
                </div>
                {!false && (
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">USR-1204</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Saif Ur Rehman
                                </td>
                                <td className="px-6 py-4 text-gray-600">admin@nextgen.com</td>
                                <td className="px-6 py-4 text-gray-600">Super Admin</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">USR-1205</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Hassan Ali
                                </td>
                                <td className="px-6 py-4 text-gray-600">hassan@example.com</td>
                                <td className="px-6 py-4 text-gray-600">Vendor</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">USR-1206</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Fatima Z.
                                </td>
                                <td className="px-6 py-4 text-gray-600">fatima@example.com</td>
                                <td className="px-6 py-4 text-gray-600">Customer</td>
                                <td className="px-6 py-4 text-gray-600">Mar 20, 2026</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-700"><span className="w-1.5 h-1.5 rounded-full bg-gray-500"></span>Inactive</span>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
