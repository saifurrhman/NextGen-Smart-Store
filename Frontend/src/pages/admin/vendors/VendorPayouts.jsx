...
import { DollarSign, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your vendor payouts</p>
                </div>
                {!false && (
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5 border-b border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50/30">
                    <div className="relative flex-1 w-full max-w-md">
                        ...
                        <input 
                            type="text" 
                            placeholder="Search in Vendor Payouts..." 
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">PAY-1102</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Tech Hub
                                </td>
                                <td className="px-6 py-4 text-gray-600">PKR 150,000</td>
                                <td className="px-6 py-4 text-gray-600">HBL ****1234</td>
                                <td className="px-6 py-4 text-gray-600">Today</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700"><span className="w-1.5 h-1.5 rounded-full bg-amber-500"></span>Processing</span>
                                </td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">PAY-1101</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Style Studio
                                </td>
                                <td className="px-6 py-4 text-gray-600">PKR 45,000</td>
                                <td className="px-6 py-4 text-gray-600">Meezan ****9987</td>
                                <td className="px-6 py-4 text-gray-600">Yesterday</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-green-50 text-green-700"><span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>Completed</span>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
