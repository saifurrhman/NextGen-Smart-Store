...
import { Ticket, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">WELCOME20</td>
                                <td className="px-6 py-4 text-gray-600">
                                    20% Off
                                </td>
                                <td className="px-6 py-4 text-gray-600">$50.00</td>
                                <td className="px-6 py-4 text-gray-600">Jan 1, 2026</td>
                                <td className="px-6 py-4 text-gray-600">Dec 31, 2026</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">Active</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">SUMMERVIBES</td>
                                <td className="px-6 py-4 text-gray-600">
                                    15% Off
                                </td>
                                <td className="px-6 py-4 text-gray-600">None</td>
                                <td className="px-6 py-4 text-gray-600">Jun 1, 2026</td>
                                <td className="px-6 py-4 text-gray-600">Aug 31, 2026</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">Active</td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">FLASH50</td>
                                <td className="px-6 py-4 text-gray-600">
                                    50% Off
                                </td>
                                <td className="px-6 py-4 text-gray-600">$100.00</td>
                                <td className="px-6 py-4 text-gray-600">Jul 4, 2026</td>
                                <td className="px-6 py-4 text-gray-600">Jul 5, 2026</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">Expired</td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-red-500 transition-colors"><Trash2 size={16} /></button>
