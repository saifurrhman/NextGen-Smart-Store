                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Free Shipping Over $50</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Conditional
                                </td>
                                <td className="px-6 py-4 text-gray-600">100% Shipping</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600">Unlimited</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">2,451 times</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Buy 1 Get 1 50% Off</td>
                                <td className="px-6 py-4 text-gray-600">
                                    BOGO
                                </td>
                                <td className="px-6 py-4 text-gray-600">50% Item</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600">500</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">342 times</td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-red-500 transition-colors"><Trash2 size={16} /></button>
