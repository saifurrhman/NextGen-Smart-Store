        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your campaign analytics</p>
                </div>
                {!false && (
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5 border-b border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50/30">
                    <div className="relative flex-1 w-full max-w-md">
                        ...
                        <input 
                            type="text" 
                            placeholder="Search in Campaign Analytics..." 
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Total Marketing ROI</td>
                                <td className="px-6 py-4 text-gray-600">
                                    284%
                                </td>
                                <td className="px-6 py-4 text-gray-600">241%</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Customer Acquisition Cost</td>
                                <td className="px-6 py-4 text-gray-600">
                                    $14.50
                                </td>
                                <td className="px-6 py-4 text-gray-600">$16.20</td>
                                <td className="px-6 py-4 text-gray-600">-10.5%</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">AOV (Ad-driven)</td>
                                <td className="px-6 py-4 text-gray-600">
                                    $85.40
                                </td>
                                <td className="px-6 py-4 text-gray-600">$78.10</td>
                                <td className="px-6 py-4 text-gray-600">+9.3%</td>
                                <td className="px-6 py-4 text-gray-600">Up</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Total Ad Spend</td>
                                <td className="px-6 py-4 text-gray-600">
                                    $4,500
                                </td>
                                <td className="px-6 py-4 text-gray-600">$3,800</td>
                                <td className="px-6 py-4 text-gray-600">+18.4%</td>
                                <td className="px-6 py-4 text-gray-600">Up</td>
