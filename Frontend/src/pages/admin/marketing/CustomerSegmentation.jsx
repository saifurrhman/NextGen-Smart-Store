        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your customer segmentation</p>
                </div>
                {!false && (
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5 border-b border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50/30">
                    <div className="relative flex-1 w-full max-w-md">
                        ...
                        <input 
                            type="text" 
                            placeholder="Search in Customer Segmentation..." 
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Risk of Churn</td>
                                <td className="px-6 py-4 text-gray-600">
                                    No purchase in 90 days
                                </td>
                                <td className="px-6 py-4 text-gray-600">4,500</td>
                                <td className="px-6 py-4 text-gray-600">$65.00</td>
