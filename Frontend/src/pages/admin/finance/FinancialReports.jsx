...
import { BarChart, Plus, Search, Filter, Download } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-semibold text-brand-dark flex items-center gap-2">
                        <BarChart size={22} className="text-brand" />
                        Financial Reports
                    </h2>
                    <p className="text-sm text-gray-500 mt-1">Generate and download detailed financial statements</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-16 flex flex-col items-center justify-center text-center">
                    <div className="w-16 h-16 bg-brand/5 rounded-full flex items-center justify-center mb-4">
                        <BarChart size={32} className="text-brand" />
                    </div>
                    <h3 className="text-lg font-medium text-brand-dark">No records found</h3>
                    <p className="text-sm text-gray-500 mt-1 max-w-sm">No data is currently available for Financial Reports. Try adjusting your filters or search terms.</p>
                </div>
            </div>
        </div>
    );
