        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Track daily, weekly, and monthly revenue trends</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-16 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-1 max-w-sm">No data is currently available for Revenue Analytics. Try adjusting your filters or search terms.</p>
                </div>
            </div>
        </div>
    );
