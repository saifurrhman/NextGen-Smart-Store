...
import { RefreshCcw, Plus, Search, Filter, Download } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and approve customer refund requests</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-16 flex flex-col items-center justify-center text-center">
                    <div className="w-16 h-16 bg-brand/5 rounded-full flex items-center justify-center mb-4">
                        <RefreshCcw size={32} className="text-brand" />
                    </div>
                    <h3 className="text-lg font-medium text-brand-dark">No records found</h3>
                    <p className="text-sm text-gray-500 mt-1 max-w-sm">No data is currently available for Refund Processing. Try adjusting your filters or search terms.</p>
                </div>
            </div>
        </div>
    );
