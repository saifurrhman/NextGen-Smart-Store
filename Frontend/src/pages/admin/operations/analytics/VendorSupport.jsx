...
import { Headphones, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">TIC-001</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Gadget Hub
                                </td>
                                <td className="px-6 py-4 text-gray-600">Payout Delay</td>
                                <td className="px-6 py-4 text-gray-600">High</td>
                                <td className="px-6 py-4 text-gray-600">2 hrs ago</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700"><span className="w-1.5 h-1.5 rounded-full bg-amber-500"></span>Open</span>
                                </td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">TIC-002</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Style Boutique
                                </td>
                                <td className="px-6 py-4 text-gray-600">Product Listing</td>
                                <td className="px-6 py-4 text-gray-600">Medium</td>
                                <td className="px-6 py-4 text-gray-600">5 hrs ago</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    In Progress
                                </td>
                                <td className="px-6 py-4 text-right">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">TIC-003</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Home Essentials
                                </td>
                                <td className="px-6 py-4 text-gray-600">Account Access</td>
                                <td className="px-6 py-4 text-gray-600">Low</td>
                                <td className="px-6 py-4 text-gray-600">1 day ago</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-green-50 text-green-700"><span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>Resolved</span>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-brand transition-colors"><Edit2 size={16} /></button>
