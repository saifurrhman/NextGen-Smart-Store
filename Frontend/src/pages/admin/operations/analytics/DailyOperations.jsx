...
import { Sun, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Today</td>
                                <td className="px-6 py-4 text-gray-600">
                                    1,240
                                </td>
                                <td className="px-6 py-4 text-gray-600">850</td>
                                <td className="px-6 py-4 text-gray-600">310</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Yesterday</td>
                                <td className="px-6 py-4 text-gray-600">
                                    980
                                </td>
                                <td className="px-6 py-4 text-gray-600">980</td>
                                <td className="px-6 py-4 text-gray-600">980</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Feb 24, 2026</td>
                                <td className="px-6 py-4 text-gray-600">
                                    1,105
                                </td>
                                <td className="px-6 py-4 text-gray-600">1,105</td>
                                <td className="px-6 py-4 text-gray-600">1,100</td>
