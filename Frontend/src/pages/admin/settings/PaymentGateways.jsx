...
import { CreditCard, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your payment gateways</p>
                </div>
                {!false && (
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5 border-b border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50/30">
                    <div className="relative flex-1 w-full max-w-md">
                        ...
                        <input 
                            type="text" 
                            placeholder="Search in Payment Gateways..." 
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Stripe Credit Card</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Stripe
                                </td>
                                <td className="px-6 py-4 text-gray-600">2.9% + 30¢</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">JazzCash Mobile</td>
                                <td className="px-6 py-4 text-gray-600">
                                    JazzCash
                                </td>
                                <td className="px-6 py-4 text-gray-600">1.5%</td>
                                <td className="px-6 py-4 text-gray-600">95.2%</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    Configure
                                </td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Cash on Delivery</td>
                                <td className="px-6 py-4 text-gray-600">
                                    Internal
                                </td>
                                <td className="px-6 py-4 text-gray-600">0%</td>
                                <td className="px-6 py-4 text-gray-600">85.4%</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600 font-medium">
                                    Configure
                                </td>
