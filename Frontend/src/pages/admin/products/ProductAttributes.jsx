...
import { List, Search, Filter, Download, Plus, MoreVertical, Edit2, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your product attributes</p>
                </div>
                {!false && (
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Color</td>
                                <td className="px-6 py-4 text-gray-600">
                                    color
                                </td>
                                <td className="px-6 py-4 text-gray-600">Red, Blue, Green, Black</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600">undefined</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-gray-600">S, M, L, XL</td>
                                <td className="px-6 py-4 text-gray-600">Active</td>
                                <td className="px-6 py-4 text-gray-600">undefined</td>
