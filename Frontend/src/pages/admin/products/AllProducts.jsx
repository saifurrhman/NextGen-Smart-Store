        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and view your all products</p>
                </div>
                {!false && (
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-gray-600">PKR 3,500</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-gray-600">Beauty</td>
                                <td className="px-6 py-4 text-gray-600">PKR 800</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-gray-900">Gaming Mouse</td>
                                <td className="px-6 py-4 text-gray-600">
                                    SKU-0914
                                </td>
                                <td className="px-6 py-4 text-gray-600">Electronics</td>
                                <td className="px-6 py-4 text-gray-600">PKR 4,200</td>
