...
import { Lock, Mail, User, AlertCircle, Eye, EyeOff, ArrowRight, BarChart3, Rocket } from 'lucide-react';
        ...
        try {
            ...
            navigate('/verify-otp', {
                state: {
                    ...
                    role: 'delivery',
                    formData: {
                        username: formData.fullName,   // ✅ fixed: was formData.username
                        email: formData.email.trim().toLowerCase(),
    ...
    return (
        <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-5">
                <h2 className="text-2xl font-black text-gray-900 tracking-tighter uppercase">Delivery Logistics Enrollment</h2>
                <p className="mt-1 text-xs font-bold text-gray-400 uppercase tracking-widest">Empower the movement of goods</p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-7">
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Field label="Full Name" name="fullName" placeholder="FULL_LEGAL_NAME" icon={User} required />
                        <Field label="Fleet Email" name="email" type="email" placeholder="FLEET@EMAIL.COM" icon={Mail} required />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                    ...
                    <button type="submit" disabled={loading}
                        ...
                        {loading ? 'DEPLOYING...' : 'AUTHORIZE ENROLLMENT'}
                    </button>
                </form>
