            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-7">
                ...
                <div className="mt-6 flex flex-col gap-4">
                    <div className="relative flex items-center">
                        ...
                        <span className="px-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">New Administrator?</span>
                        <div className="flex-1 border-t border-gray-100" />
                    </div>
                    <Link to="/admin/register" className="w-full flex justify-center items-center gap-2 py-3 border border-gray-100 rounded-2xl bg-gray-50 hover:bg-gray-100 text-xs font-black text-gray-700 uppercase tracking-widest transition-all group">
                    ...
                    <p className="text-center text-[9px] text-gray-300 font-bold uppercase tracking-widest">Hardware Encrypted | Session Logged</p>
                </div>
            </div>
        </div>
    );
