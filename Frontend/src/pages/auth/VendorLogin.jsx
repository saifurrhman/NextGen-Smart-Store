...
import { Store, Lock, Mail, AlertCircle, ArrowRight, Eye, EyeOff, Building2, BarChart3, Rocket } from 'lucide-react';
    ...
    return (
        <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-5">
                <h2 className="text-2xl font-black text-gray-900 tracking-tighter uppercase">Vendor Terminal</h2>
                <p className="mt-1 text-xs font-bold text-gray-400 uppercase tracking-widest">Connect to your enterprise dashboard</p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-7">
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[11px] font-black text-gray-400 uppercase tracking-[0.15em] ml-1">Business Identifier</label>
